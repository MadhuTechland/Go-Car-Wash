...
class BookingDetailScreenState extends State<BookingDetailScreen>
            ...
            children: [
              AnimatedScrollView(
                ...
                children: [
                  ...
                  if (res.data!.bookingDetail!.plan != null &&
                      res.data!.bookingDetail!.bookingsType != 'instant')
                    planDetailsWidget(bookingDetail: res.data!.bookingDetail!),
  ...
  Widget planDetailsWidget({required BookingData bookingDetail}) {
    if (bookingDetail.plan == null) {
      return Offstage();
    }
    ...
    return Column(
      ...
      children: [
        24.height,
        Text('Plan Details', style: boldTextStyle(size: LABEL_TEXT_SIZE)),
        16.height,
        Container(
          decoration: boxDecorationWithRoundedCorners(
            backgroundColor: context.cardColor,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      bookingDetail.plan!.name.validate(),
              ...
              Row(
                ...
                children: [
                  Text(
                    languages.lblAmount ?? 'Amount',
                    style: secondaryTextStyle(size: 14),
                  ),
                  PriceWidget(
                    price: bookingDetail.plan!.amount.validate().toDouble(),
                    color: primaryColor,
                    isBoldText: true,
                    size: 16,
                  ),
