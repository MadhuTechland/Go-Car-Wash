...
import '../../screens/take_subscription_screen.dart';
import '../../utils/configs.dart';
import '../../utils/constant.dart';
import '../controller/get_subscription_controller.dart';
import 'model/service_list_approval_status_model.dart';

class ServiceListScreen extends StatefulWidget {
  final bool showBackIcon;

  ServiceListScreen({this.showBackIcon = true});
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        ...
        showBack: widget.showBackIcon,
        backWidget: widget.showBackIcon ? BackWidget() : null,
        ...
        actions: [
          ...
          //       bool? res = await AddServices().launch(
          //         context,
          ...
          //       }
          //     } else {
          //       TakeSubscriptionMessage(showAppBar: true).launch(
          //         context,
          //         pageRouteAnimation: PageRouteAnimation.Fade,
          //       );
          //     }
